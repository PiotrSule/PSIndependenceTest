...
The goal of the PSIndependenceTest package is to put into practice the modular and logarithmic minimum tests for independence in two-way, three-way and four-way contingency tables. Statistic value, cv value and p-value are calculated. This package also includes three table generation functions and six data sets. To read more about the package please see (and cite :)) papers:
...
```{r}
Mod2.cv(2, 2, 40, 0.05, B = 1e3) #related to table1
Mod2.cv(2, 3, 25, 0.1, B = 1e4) #related to table2
```
...
```{r}
Mod2.pvalue(Mod2.stat(table2), 2, 2, 40, B = 1e3)
...
```{r}
Lms2.cv(2, 2, 40, 0.05, B = 1e3) #related to table1
Lms2.cv(2, 3, 25, 0.1, B = 1e4) #related to table2
```
...
```{r}
Mod3.cv(2, 3, 4, 100, 0.05, B = 1e3) #related to table4
Mod3.cv(2, 3, 4, 100, 0.1, B = 1e4) #related to table4
```
...
```{r}
Lms3.cv(2, 3, 4, 100, 0.05, B = 1e3) #related to table4
Lms3.cv(2, 3, 4, 100, 0.1, B = 1e4) #related to table4
```
...
```{r}
Mod4.cv(2, 2, 2, 2, 100, 0.05, B = 1e3) #related to table6
Mod4.cv(2, 2, 2, 2, 100, 0.1, B = 1e4) #related to table6
```
...
```{r}
Lms4.cv(2, 2, 2, 2, 100, 0.05, B = 1e3) #related to table6
Lms4.cv(2, 2, 2, 2, 100, 0.1, B = 1e4) #related to table6
```
