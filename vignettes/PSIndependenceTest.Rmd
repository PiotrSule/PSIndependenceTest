...
Mod2.pvalue(Mod2.stat(table2), 2, 3, 40)
```
...
Lms2.pvalue(Lms2.stat(table2), 2, 3, 25)
```
...
```{r}
Mod3.pvalue(Mod3.stat(table3), 2, 3, 4, 100, B = 1e3)
...
```{r}
Mod4.pvalue(Mod4.stat(table6), 2, 2, 2, 3, 100, B = 1e3)
Mod4.pvalue(Mod4.stat(table6), 2, 2, 2, 3, 100)
```
...
```{r}
Lms4.pvalue(Lms4.stat(table6), 2, 2, 2, 3, 100, B = 1e3)
Lms4.pvalue(Lms4.stat(table6), 2, 2, 2, 3, 100)
```
