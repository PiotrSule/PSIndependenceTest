...
test_that("Statistic formula is correct",{expect_equal(round(Lms2.stat(table2),4),14.0588)})
...
test_that("Statistic formula is correct",{expect_equal(round(Lms3.stat(table4),4),10.1226)})
...
test_that("Statistic formula is correct",{expect_equal(round(Lms4.stat(table5),4),36.9214)})
