...
Mod2.pvalue(Mod2.stat(table2), 2, 4, 80)
```
...
Lms2.pvalue(Mod2.stat(table2), 2, 4, 80)
```
...
```{r}
Mod3.cv(2, 3, 4, 240, 0.05, B = 1e3) 
Mod3.cv(2, 3, 4, 240, 0.1) 
```
...
```{r}
Mod3.pvalue(Mod3.stat(table3), 3, 3, 2, 695, B = 1e3)
Mod3.pvalue(Mod3.stat(table3), 3, 3, 2, 695, B = 1e2)
```
...
```{r}
Mod3.test(table3, B = 1e3)
Mod3.test(table3, B = 1e2)
```
...
```{r}
Lms3.cv(2, 3, 4, 240, 0.05, B = 1e3) 
Lms3.cv(2, 3, 4, 240, 0.1) 
```
...
```{r}
Lms3.pvalue(Lms3.stat(table3), 3, 3, 2, 695, B = 1e3)
Lms3.pvalue(Lms3.stat(table3), 3, 3, 2, 695, B = 1e2)
```
...
```{r}
Lms3.test(table3, B = 1e3)
Lms3.test(table3, B = 1e2)
```
...
```{r}
Mod4.cv(2, 2, 2, 2, 160, 0.05, B = 1e3)
Mod4.cv(2, 2, 2, 2, 160, 0.1)
```
...
```{r}
Mod4.pvalue(Mod4.stat(table5), 4, 2, 2, 2, 2201, B = 1e3)
Mod4.pvalue(Mod4.stat(table5), 4, 2, 2, 2, 2201, B = 1e2)
```
...
```{r}
Mod4.test(table5, B = 1e3)
Mod4.test(table5, B = 1e2)
```
...
```{r}
Lms4.cv(2, 2, 2, 2, 160, 0.05, B = 1e3) 
Lms4.cv(2, 2, 2, 2, 160, 0.1) 
```
...
```{r}
Lms4.pvalue(Lms4.stat(table5), 4, 2, 2, 2, 2201, B = 1e3)
Lms4.pvalue(Lms4.stat(table5), 4, 2, 2, 2, 2201, B = 1e2)
```
...
```{r}
Lms4.test(table5, B = 1e3)
Lms4.test(table5, B = 1e2)
```
